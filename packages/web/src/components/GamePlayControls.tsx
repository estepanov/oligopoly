...
export function GamePlayControls({
  ...
  // The trade desk must stay visible across every phase (including
  // insider-peek and game-over, and during non-action phases so recipients can
  // respond). Render it once from a single layout shell above the
  // phase-specific content so new early-return phases can't accidentally drop
  // it.
          ...
          <div className="buttonRow">
            ...
            {actions.canEndTurn && (
              <button
                ...
                disabled={busy}
                onClick={() =>
                  void onAction("Ended turn", { type: "end_turn" })
                }
              >
