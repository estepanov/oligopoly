...
export const MARKET_EVENT_DECK: Record<string, MarketEventCard> = {
  ...
  healthcare_scandal: {
    id: "healthcare_scandal",
    name: "Healthcare Scandal",
    category: "negative",
  },
  data_breach_fine: {
    id: "data_breach_fine",
  ...
  financial_meltdown: {
    id: "financial_meltdown",
    name: "Financial Meltdown",
    category: "negative",
  },
  ...
  hostile_takeover_alert: {
    id: "hostile_takeover_alert",
    name: "Hostile Takeover Alert",
    category: "targeted",
  },
  whistleblower: {
    id: "whistleblower",
...
export const MARKET_EVENT_DECK_IDS = Object.keys(
  MARKET_EVENT_DECK,
